...
<div class="bodywrapper">
    ...
    <div class="header">
        <ul class="headermenu">
            <li class="<?= $item === 'frame' ? 'current' : '';?>"><a href="/"><span class="icon icon-flatscreen"></span>首页</a></li>
            ...
            <li class="<?= $item === 'member' ? 'current' : '';?>"><a href="/admin/member/index"><span class="icon icon-message"></span>会员管理</a></li>
